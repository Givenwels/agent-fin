...
试试：
  ...
  · 帮我做一套稳健型的资产配置
命令：/help · /api · /context · /portfolio · /journal · /memory · /sources · /cost · exit 退出
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""

HELP_TEXT = """可用命令（本地直接执行，不耗 token）：
  /help  /api 看接口状态  /context 看上下文状态  /portfolio 看持仓  /plan 看任务计划  /journal 看日记  /memory  /sources
...
async def main() -> None:
    ...
    stats = {"turns": 0, "tokens": 0, "context_compactions": 0, "tool_errors": 0}
